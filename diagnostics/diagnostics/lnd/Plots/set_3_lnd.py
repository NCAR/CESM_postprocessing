...
class set_3(LandDiagnosticPlot):
    """Set 3 Plots
    """

    def __init__(self, env):
        super(set_3, self).__init__()

        # Set plot class description variables
        self._name = 'Set 3 Plots'
        self._shortname = 'set_3'
        self._template_file = 'set_3.tmpl'
        self.ncl_scripts = ['set_3.ncl']
