...
class set_1(LandDiagnosticPlot):
    """Set 1 Plots
    """

    def __init__(self, env):
        super(set_1, self).__init__()

        # Set plot class description variables
        self._name = 'Set 1 Plots'
        self._shortname = 'set_1'
        self._template_file = 'set_1.tmpl'
        self.ncl_scripts = ['set_1.ncl']
