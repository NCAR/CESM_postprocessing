...
class set_12(LandDiagnosticPlot):
    """Set 12 Plots
    """

    def __init__(self, env):
        super(set_12, self).__init__()

        # Set plot class description variables
        self._name = 'Set 12 Plots'
        self._shortname = 'set_12'
        self._template_file = 'set_12.tmpl'
        self.ncl_scripts = ['set_12.ncl']
