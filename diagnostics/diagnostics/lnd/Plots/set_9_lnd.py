...
class set_9(LandDiagnosticPlot):
    """Set 9 Plots
    """

    def __init__(self, env):
        super(set_9, self).__init__()

        # Set plot class description variables
        self._name = 'Set 9 Plots'
        self._shortname = 'set_9'
        self._template_file = 'set_9.tmpl'
        self.ncl_scripts = ['set_9.ncl']
