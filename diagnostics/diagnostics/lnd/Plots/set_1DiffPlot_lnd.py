...
class set_1DiffPlot(LandDiagnosticPlot):
    """Set 1 Plots
    """

    def __init__(self, env):
        super(set_1DiffPlot, self).__init__()

        # Set plot class description variables
        self._name = 'Set 1 Diff Plots'
        self._shortname = 'set_1DiffPlot'
        self._template_file = 'set_1DiffPlot.tmpl'
        self.ncl_scripts = ['set_1DiffPlot.ncl']
