...
class set_8_zonal_lnd(LandDiagnosticPlot):
    """Set set_8_zonal_lnd Plots
    """
    ...
    def __init__(self, env):
        ...
        self._shortname = 'set_8_zonal_lnd'
        self._template_file = 'set_8_zonal_lnd.tmpl'
        self.ncl_scripts = ['set_8_zonal_lnd.ncl']
