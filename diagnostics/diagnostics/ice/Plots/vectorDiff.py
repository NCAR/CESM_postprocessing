...
class VectorDiff(IceDiagnosticPlot):
    """Vector Diff Plots
    """

    def __init__(self, env):
        super(VectorDiff, self).__init__()

        # Derive all of the plot names

        # Set plot class description variables
        self._name = 'Vector Diff Plots'
        self._shortname = 'PLOT_VECT_DIFF'
        self._template_file = 'vect_diff.tmpl'
        self.ncl_scripts = ['vect_diff.ncl']
