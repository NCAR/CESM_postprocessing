...
class Web_Hem_Avg_wPIOMASDiff(IceDiagnosticPlot):
    """Web_Hem_Avg_wPIOMASDiff Plots
    """

    def __init__(self, env):
        super(Web_Hem_Avg_wPIOMASDiff, self).__init__()
        ...
        self.plot_env['MODEL_VS_MODEL'] = True
