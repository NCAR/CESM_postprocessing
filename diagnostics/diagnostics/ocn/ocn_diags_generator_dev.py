...
# import for ocn diagnostic helper modules
from diagnostics.ocn import create_clim_files
...
def main(options, scomm):
    ...
    try:
        create_clim_files.createClimFiles(envDict['YEAR0'], envDict['YEAR1'], envDict['in_dir'],
