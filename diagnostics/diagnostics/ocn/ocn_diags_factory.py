...
import model_vs_obs.py
#import model_vs_obs_ecosys.py
#import model_vs_model.py
#import model_vs_model_ecosys.py
#import modelts.py
#import modelts_ecosys.py

def oceanDiagnosticDiagFactory(diag_type):
