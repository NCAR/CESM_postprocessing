...
set echo on
set BASE_DIR = /web/web-data/oce/landrum/ice_diag
...
if !(-d $NEW_DIR) then
  ...
  mkdir -p -m 0775 ${NEW_DIR}/maps
  mkdir -p -m 0775 ${NEW_DIR}/obs
  ...
  cp ${BASE_DIR}/maps/*.png   ${NEW_DIR}/maps
  cp ${BASE_DIR}/obs/*.txt   ${NEW_DIR}/obs

  echo "Done moving png files and copying obs files"
  ...
  if !(-e $HTML_FILE) then
    ...
    cp ${BASE_DIR}/diff_plots_new.html $HTML_FILE
