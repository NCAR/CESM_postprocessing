...
if !(-d $NEW_DIR) then
  ...
  mv ${NEW_DIR}/diff_con_*.gif  ${NEW_DIR}/contour
  mv ${NEW_DIR}/diff_vec_*.gif  ${NEW_DIR}/vector
  mv ${NEW_DIR}/line*diff.gif   ${NEW_DIR}/line
  ...
  if !(-e $HTML_FILE) then
    ...
    cp ${BASE_DIR}/diff_plots.html $HTML_FILE
...
EOF
    ...
    mv -f ${NEW_DIR}/temp.html ${NEW_DIR}/diff_plots.html
