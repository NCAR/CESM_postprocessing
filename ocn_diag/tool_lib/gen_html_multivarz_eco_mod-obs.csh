...
#
#  Usage:
#	gen_html_multivarz_eco_mod-obs.csh nvar var1 var2 ... ncol z1 z2 z3 z4 ...
#		where 
#	             nvar = # of variables
...
while ($lnk <= $ndep)
  ...
  if (${curvar} == "Fe") then
   echo "  <TH ALIGN=LEFT><A HREF="map_${curvar}_${depths[$lnk]}m.png">${depths[$lnk]}m</a>&nbsp;" >> tmp.html
  else
   echo "  <TH ALIGN=LEFT><A HREF="mod_obs_map_${curvar}_${depths[$lnk]}m.png">${depths[$lnk]}m</a>&nbsp;" >> tmp.html
  endif
