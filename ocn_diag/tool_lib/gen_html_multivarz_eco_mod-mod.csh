...
#
#  Usage:
#	gen_html_multivarz_eco_mod-mod.csh nvar var1 var2 ... ncol z1 z2 z3 z4 ...
#		where 
#	             nvar = # of variables
...
while ($lnk <= $ndep)
  ...
  if ($lnk == 1) then
   ...
   echo "  <TH ALIGN=LEFT><A HREF="map_${curvar}_${depths[$lnk]}m_diff.png">${depths[$lnk]}m</a>&nbsp;" >> tmp.html
